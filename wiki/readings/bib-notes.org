...
** TOREAD Swoosh: a generic approach to entity resolution
...
** TOREAD How not to evaluate your dialogue system: An empirical study of unsupervised evaluation metrics for dialogue response generation
SCHEDULED: <2018-10-06 Sat 15:00>
:PROPERTIES:
