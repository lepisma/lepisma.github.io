...
(defun+ some-func (x y)
  "hello"
  (defer (print "the last deferred expression"))
  (defer (print "second deferred"))
  (print "hello world")
  (if nil (defer (print "first deferred")))
  (defer (print "this will be evaluated first"))
  (if t (return 33))
  (+ x y))

(print (format "Finall, the returned value is %s" (some-func 1 2)))
#+END_SRC
...
"Finall, the returned value is 33"
#+end_example
