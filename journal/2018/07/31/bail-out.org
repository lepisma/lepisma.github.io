...
is useless. Also a better way to implement this would use [[https://www.gnu.org/software/emacs/manual/html_node/elisp/Catch-and-Throw.html][catch-and-throw]].
#+END_QUOTE
...
Another gloriously messy example is [[https://github.com/lepisma/read-lyrics.el/blob/54a2c4c383d239761c4d9103e76319dea12c0291/read-lyrics.el#L53-L78][this one]]. Thse cases commmon in the /main/
functions of packages since they have to work on edges.
