...
phone. Another such utility bump has come with [[https://community.kde.org/KDEConnect][KDE Connect]]. Its features are
listed in the website. Two features I like and use the most are:
...
scripting--the--mobile part to the laptop. With access to things like mobile
notifications, I can finally automate a lot of things like (I still need to
hijack the notification daemon in my machine):
...
softwares. The good thing with KDE connect is that its /freer/ and more hackable
