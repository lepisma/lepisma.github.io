...
You a Haskell]] and solving a few problems with it.
...
Haven't got to use it as of now, but most likely will be moving towards it since
it is easy to make it work /with/ python.
...
I have no idea how graphics programming. Hopefully, working on a few ideas with
procedural generation and stuff will help in getting this.
