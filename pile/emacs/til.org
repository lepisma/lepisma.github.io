...
+ *magic file names*
  ...
  You can define specific /handlers/ for specific file name patterns which can
  then override the behavior in interesting ways. [[https://bitbucket.org/jpkotta/openwith][openwith]] exploit this by
