...
Tukey here was pointing to certain /ossifications/ that are hindering rapid growth
and novelty in the /then/ field of Data Analysis.
...
work can be /composed/ together easily. For theoretical works, there is nothing
specific, at the moment, needed other than a will. But for computational works,
in Machine Learning for example, this translates to nice composability
properties in research code repositories.
...
importantly, it forces us spend plain thinking time on how a work can be
...
of papers can more explicitly map to extension points in our programs.
...
created as a library, but I feel many others can.]
...
conventions and guidelines. I don't quite believe the utopia where people point
to some $n$ works/paper/repositories, mix their own ideas at very high level and
start analysing results is possible, specially for researches since they produce
prototypes by design. But we might be able go surprisingly far from where we are
if we align some of our code and prose efforts in this direction.
