...
[[https://syncthing.net/][syncthing]]. Along with help of the excellent [[https://github.com/alphapapa/org-super-agenda][org-super-agenda]], orgzly lets me /not
avoid/ scheduled items since now I don't have to /pull/ up the agenda manually.
Since I have a phone nearby most of the time, its easy to go both ways now:
