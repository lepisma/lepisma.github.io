...
#+BEGIN_QUOTE
Categorization of books in sections is in progress
#+END_QUOTE
...
/Sorting is based on date added (recent first)/. I am trying to make sections here
so sorting is valid /inside/ the sections only.
...
** General Science
The catch all section for science.
...
** Soft Science, History, Biographies etc.
...
** Uncategorized
This mostly contains items which I haven't read so don't know how to categorize.
