...
The very first thing that did was to start asking people for research papers
...
difference in interests start to reduce the overall engagement.
...
+ Nudge towards the /utilitarian aspects/ of the ideas presented so that audience
  follow a few threads of experimentation.

* People
With people, we can think in the following terms[fn::Many are derived from an
internal note by [[https://github.com/janaab11/][Manas]]]:

+ Resourcefulness.
+ Motivation.
+ Interests and their depths and varieties.
+ Style and method of working with new knowledge.
+ Level of comfort with group sessions. Both for presentation and discussion.
+ Bandwidth. This becomes specially important in industrial settings like ours.
...
moment of time, but even a minimal set is sufficiently diverse. The key idea is
accept a pluralistic view on the issue. There is no /single/ fundamentally correct
way of doing these sessions, and it's better to pick a digestible subset and
solve for that.
...
Seminars cover many of the issues nicely and they clearly don't touch many
...
Each of these has a plan of what's supposed to be discussed over a period of 1-2
months. While not perfect, these are developing in decent reading roadmap for
the topics. Something we would like to open out after a couple of months,
similar to what we did with the old style [[https://backyard.vernacular.ai/paper-reading/][paper reading]] sessions.
