...
#+HTML_HEAD_EXTRA:   var epigraph = document.getElementsByClassName('epigraph')[0];
#+HTML_HEAD_EXTRA: 
#+HTML_HEAD_EXTRA:   for (var i = epigraph.children.length; i >= 0; i--) {
#+HTML_HEAD_EXTRA:     epigraph.appendChild(epigraph.children[Math.random() * i | 0]);
#+HTML_HEAD_EXTRA:   }
#+HTML_HEAD_EXTRA: })
#+HTML_HEAD_EXTRA: </script>
...
#+BEGIN_QUOTE
writing. Do not play the solitary genius.
