...
moved things around and have a different writing setup now]. The =pile= is
fundamentally a place to log things in the process of gathering and playing
around with knowledge of any kind. This makes it more of an assistive tool for
myself than anyone else. Using org mode helps a lot in this /selfish/ endeavor
because of [[https://orgmode.org/worg/org-contrib/babel/][org-babel]] (for authoring code based pages) and [[https://orgmode.org/manual/Publishing.html][org-publish]] (for
