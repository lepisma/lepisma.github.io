...
d3.csv('/scripts/posts/time-maps/counts-lfm.csv', function (error, data) {
...
d3.csv('/scripts/posts/time-maps/diffs-lfm.csv', function (error, data) {
...
d3.csv('/scripts/posts/time-maps/diffs-lfm-dd.csv', function (error, data) {
  let dt = filterScrobbleDiffs(parseDiffs(data))
  new tufte.ScatterPlot(
    '#diffs-lfm-dd',
    dt,
...
// Tweet plots
d3.csv('/scripts/posts/time-maps/counts-tw.csv', function (error, data) {
...
d3.csv('/scripts/posts/time-maps/diffs-tw.csv', function (error, data) {
