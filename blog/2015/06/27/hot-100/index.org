...
components as perceived by your subjective senses. One example can be (lets say)
a value that signifies the sadness of songs.
...
/In what ways can they help?/ Actually, in a lot of ways. But lets start with the
