...
notebook in my editor and its a mess of JSON waiting to force you into believing
that its just a set of simple scripts you wrote to do something much simpler
than

> working interactively with large and complex datasets

[RMarkdowns](http://rmarkdown.rstudio.com/) shine here. They are by default
