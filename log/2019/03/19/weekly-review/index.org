...
- [[https://petewarden.com/2016/05/03/how-to-quantize-neural-networks-with-tensorflow/][How to Quantize Neural Networks with TensorFlow « Pete Warden's blog]]. There is
  a lot of cool things happening on the runtime side of neural nets.
