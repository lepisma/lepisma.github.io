...
This malleability is not only a learning[fn::Many researches in self learning
systems are orthogonal here as you can have low generalization and still make a
natural language REPL.] but also design problem at the moment. A problem similar
to designing a programming language. What we want the language user to
