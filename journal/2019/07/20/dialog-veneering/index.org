...
of counter behaviors shown up from the human side. Compared to human-human
conversations, it's harder to look at these conversations from the viewpoint of
earlier works in dialogue formalization like (say) [[http://www-bcf.usc.edu/~billmann/dialogue/dmt.htm][Dialogue Macrogame Theory]].
