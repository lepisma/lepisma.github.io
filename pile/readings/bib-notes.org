...
** Computation at the edge of chaos: phase transitions and emergent computation :noexport:
 :PROPERTIES:
...
Three requirements to focus on for emergence of computation.

1. Storage
2. Transmission
3. Interaction between the above 2.
