...
all the problems in a maximum-market-reach sense. Though I am not sure if this
argument works since subjectivity itself might be a side effect of such a
maximum cover problem solving approach[fn::Evolution?].
