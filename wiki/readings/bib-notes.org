...
** TOREAD Learning to map sentences to logical form: Structured classification with probabilistic categorial grammars
...
Other than the usuals, it is a decent summary for a few metrics used for
sentence similarity.
