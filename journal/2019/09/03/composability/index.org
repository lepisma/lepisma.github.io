...
also see more use of forks, submodules and dependencies network.
...
conventions and guidelines. This is hard to do at scale. I don't quite believe
the utopia where people point to some $n$ works/paper/repositories, mix their
own ideas at very high level and start analysing results is possible, specially
for researches since they produce prototypes by design. But we might be able go
surprisingly far from where we are if we align some of our code and prose
