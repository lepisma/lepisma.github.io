...
#+BEGIN_QUOTE
This is the obligatory /colophon/ page.
#+END_QUOTE

I have used jekyll in the past to maintain my [[https://github.com/lepisma/lepisma.github.io][home page]]. Its been nice really,
but extending it was painful. Some times, working directly on the system is
...
are [[https://github.com/lepisma/pile][here]]), there are three pieces that assist in publishing:

1. The [[https://github.com/lepisma/pile/blob/master/files/assets/export.setup][export setup file]] which attaches css/js scripts and provides the general
   export config.
2. [[https://github.com/lepisma/pile-theme][Theme]] for the pages. This is a slight variant of my old blog's theme. Since I
   use it at other places too (at least one), its now in a separate repository.
3. [[https://github.com/lepisma/pile-wiki][Elisp package]] for working with and publishing everything.
