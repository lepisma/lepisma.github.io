...
while working on /anything/. Its starting out jumbled but will get more organized
...
- I keep a list of utility packages that I ~:use~ in repl [[https://github.com/lepisma/cfg/blob/master/dune/package.lisp][here]]. Probably you could
  use something like [[https://github.com/cl21/cl21][cl21]] but then you would want to write packages in cl21 too.
...
- For workflow management, I find [[https://snakemake.readthedocs.io/][snakemake]] really useful. Combining it with
  ...
  probably the cleanest solution. For packages too, I am trying to use pipenv
  for the development side (tests, docs etc) with a pinch of make.
