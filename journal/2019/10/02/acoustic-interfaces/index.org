...
to a certain mode of operation can thus can be made less interfering. This is
...
here as they can be made much more expressive for their domain. As an example
consider operating computers completely with a keyboard. This needs knowledge of
text-ish capabilities and little training time which is not something everyone
...
experimental to be fair, but the amount of experiments is much higher than in
audio where most of the interesting ideas I have seen are in video games and art
installations. Maybe the pool of possibilities itself is much smaller here, but
let's try dipping toes around. In this weekend, I will try to make a list of
